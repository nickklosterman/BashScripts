...
if (!$con)
...
else
  {
    ...
    $sql = 'SELECT p.product,p.websiteCode,d.price,d.percentOffMSRP,d.quantity,d.timeEnter,d.dealdurationinminutes FROM BackcountryProducts p, BackcountryProductDetails d WHERE p.ProductEntrykey=d.ProductEntrykey AND p.websiteCode=3 ORDER BY p.product ASC' ;
    ...
    <html>
       ...
       <td bgcolor="#FFFFFF">&nbsp;</td>
				       <td colspan="8" bgcolor="#FFFFFF"><strong>Chainlove Product Database Contents</strong> </td>
				       </tr>
				       <tr>
