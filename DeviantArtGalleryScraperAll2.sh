...
#we don't want our variable to be quoted otherwise we'll get a Scheme missing error from wget
	    wget -nc -U Mozilla --referer=http://deviantart.com  --cookies=on --load-cookies=~/cookie.txt --keep-session-cookies --save-cookies=~/cookie.txt $DownloadImage
	fi
    done
}
...
function downloadallowingclobber ()
{
    ...
    do 
	echo "$x"
	wget -U Mozilla --referer=http://deviantart.com  --cookies=on --load-cookies=~/cookie.txt --keep-session-cookies --save-cookies=~/cookie.txt "$x"
    done
...
function downloadnoclobber ()
{
    ...
    do 
	echo "$x"
	wget -U Mozilla -nc  --referer=http://deviantart.com  --cookies=on --load-cookies=~/cookie.txt --keep-session-cookies --save-cookies=~/cookie.txt "$x"
    done
}
...
#without the trailing / it saves the file as gallery instead of index.html
	wget -U Mozilla --referer=http://deviantart.com  --cookies=on --load-cookies=~/cookie.txt --keep-session-cookies --save-cookies=~/cookie.txt  http://${1}.deviantart.com/gallery/ #-O $OutputFile
